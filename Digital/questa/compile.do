...
vlog -work xpm  -sv "+incdir+../../Digital Designs/Template/Template.srcs/sources_1/new" \
"E:/Vivado/Vivado/2020.2/data/ip/xpm/xpm_cdc/hdl/xpm_cdc.sv" \

vcom -work xpm  -93 \
"E:/Vivado/Vivado/2020.2/data/ip/xpm/xpm_VCOMP.vhd" \

vlog -work xil_defaultlib  "+incdir+../../Digital Designs/Template/Template.srcs/sources_1/new" \
