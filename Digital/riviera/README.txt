...
#
# Generated by export_simulation on Thu Jul 08 21:12:35 -0400 2021
#
################################################################################
...
'-reset_run' switch to the './RamInterface.sh' script.

./RamInterface.sh -reset_run
...
./RamInterface.sh -noclean_files

For more information on the script, please type './RamInterface.sh -help'.
