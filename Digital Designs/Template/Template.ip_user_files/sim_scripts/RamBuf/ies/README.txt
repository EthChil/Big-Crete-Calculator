...
#
# Generated by export_simulation on Sun Feb 28 00:49:23 -0500 2021
#
################################################################################
...
'-reset_run' switch to the './RamBuf.sh' script.
...
./RamBuf.sh -noclean_files

For more information on the script, please type './RamBuf.sh -help'.
