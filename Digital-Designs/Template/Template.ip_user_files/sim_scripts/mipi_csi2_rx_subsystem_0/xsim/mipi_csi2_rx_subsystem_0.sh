...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L generic_baseblocks_v2_1_0 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_28 -L fifo_generator_v13_2_8 -L axi_data_fifo_v2_1_27 -L axi_crossbar_v2_1_29 -L xil_defaultlib -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_13 -L mipi_csi2_rx_ctrl_v1_0_8 -L mipi_dphy_v4_3_6 -L axis_infrastructure_v1_1_0 -L axis_register_slice_v1_1_28 -L axis_dwidth_converter_v1_1_27 -L axis_switch_v1_1_28 -L vfb_v1_0_22 -L uvm -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mipi_csi2_rx_subsystem_0 xil_defaultlib.mipi_csi2_rx_subsystem_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mipi_csi2_rx_subsystem_0 -key {Behavioral:sim_1:Functional:mipi_csi2_rx_subsystem_0} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mipi_csi2_rx_subsystem_0.wdb xsim.dir libdpi.so)
