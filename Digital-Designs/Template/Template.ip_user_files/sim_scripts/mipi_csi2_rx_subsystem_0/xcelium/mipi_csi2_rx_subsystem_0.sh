...
#
# Script generated by Vivado on Wed Oct 04 10:49:44 -0400 2023
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : mipi_csi2_rx_subsystem_0.sh
...
#
# Usage        : mipi_csi2_rx_subsystem_0.sh
#                mipi_csi2_rx_subsystem_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mipi_csi2_rx_subsystem_0.sh [-reset_run]
#                mipi_csi2_rx_subsystem_0.sh [-reset_log]
#                mipi_csi2_rx_subsystem_0.sh [-help]
#
...
#                script (type 'mipi_csi2_rx_subsystem_0.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname generic_baseblocks_v2_1_0 -libname axi_infrastructure_v1_1_0 -libname axi_register_slice_v2_1_28 -libname fifo_generator_v13_2_8 -libname axi_data_fifo_v2_1_27 -libname axi_crossbar_v2_1_29 -libname xil_defaultlib -libname lib_cdc_v1_0_2 -libname proc_sys_reset_v5_0_13 -libname mipi_csi2_rx_ctrl_v1_0_8 -libname mipi_dphy_v4_3_6 -libname axis_infrastructure_v1_1_0 -libname axis_register_slice_v1_1_28 -libname axis_dwidth_converter_v1_1_27 -libname axis_switch_v1_1_28 -libname vfb_v1_0_22 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm generic_baseblocks_v2_1_0 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_28 fifo_generator_v13_2_8 axi_data_fifo_v2_1_27 axi_crossbar_v2_1_29 xil_defaultlib lib_cdc_v1_0_2 proc_sys_reset_v5_0_13 mipi_csi2_rx_ctrl_v1_0_8 mipi_dphy_v4_3_6 axis_infrastructure_v1_1_0 axis_register_slice_v1_1_28 axis_dwidth_converter_v1_1_27 axis_switch_v1_1_28 vfb_v1_0_22)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "mipi_csi2_rx_subsystem_0.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mipi_csi2_rx_subsystem_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work mipi_csi2_rx_ctrl_v1_0_8 $xmvlog_opts +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"../../../ipstatic/hdl" \
  ...
  xmvlog -work mipi_dphy_v4_3_6 $xmvlog_opts -sv +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"../../../ipstatic/hdl" \
  ...
  xmvlog -work axis_register_slice_v1_1_28 $xmvlog_opts +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"../../../ipstatic/hdl" \
  "../../../ipstatic/hdl/axis_register_slice_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axis_dwidth_converter_v1_1_27 $xmvlog_opts +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"../../../ipstatic/hdl" \
  ...
  xmvlog -work axis_switch_v1_1_28 $xmvlog_opts +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"../../../ipstatic/hdl" \
  ...
  xmvlog -work vfb_v1_0_22 $xmvlog_opts +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"../../../ipstatic/hdl" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.mipi_csi2_rx_subsystem_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.mipi_csi2_rx_subsystem_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log mipi_csi2_rx_subsystem_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mipi_csi2_rx_subsystem_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mipi_csi2_rx_subsystem_0.sh [-help]\n\
Usage: mipi_csi2_rx_subsystem_0.sh [-step]\n\
Usage: mipi_csi2_rx_subsystem_0.sh [-lib_map_path]\n\
Usage: mipi_csi2_rx_subsystem_0.sh [-reset_run]\n\
Usage: mipi_csi2_rx_subsystem_0.sh [-reset_log]\n\
Usage: mipi_csi2_rx_subsystem_0.sh [-keep_index]\n\
Usage: mipi_csi2_rx_subsystem_0.sh [-noclean_files]\n\n\
