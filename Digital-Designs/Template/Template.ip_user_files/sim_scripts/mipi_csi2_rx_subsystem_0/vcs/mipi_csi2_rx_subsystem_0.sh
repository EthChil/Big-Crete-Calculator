...
compile()
{
  ...
  vlogan -work mipi_csi2_rx_ctrl_v1_0_8 $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"../../../ipstatic/hdl" \
  ...
  vlogan -work mipi_dphy_v4_3_6 $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"../../../ipstatic/hdl" \
  ...
  vlogan -work axis_register_slice_v1_1_28 $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"../../../ipstatic/hdl" \
  "../../../ipstatic/hdl/axis_register_slice_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axis_dwidth_converter_v1_1_27 $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"../../../ipstatic/hdl" \
  ...
  vlogan -work axis_switch_v1_1_28 $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"../../../ipstatic/hdl" \
  ...
  vlogan -work vfb_v1_0_22 $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"../../../ipstatic/hdl" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.mipi_csi2_rx_subsystem_0 xil_defaultlib.glbl -o mipi_csi2_rx_subsystem_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./mipi_csi2_rx_subsystem_0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key mipi_csi2_rx_subsystem_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc mipi_csi2_rx_subsystem_0_simv.daidir vcs_lib c.obj)
