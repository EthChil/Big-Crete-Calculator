...
HD_PWD='C:/Users/ethan/Documents/GitHub/Big-Crete-Calculator/Digital-Designs/DisplayTest/DisplayTest.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HX8357.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HX8357.tcl
